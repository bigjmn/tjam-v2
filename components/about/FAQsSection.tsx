...
const faqs1 = [
	{
		...
		answer: "Drag tiles from the home row and drop them onto the board to create words. You can only move tiles from the home row (bottom row).",
	},
	{
		question: "What makes a valid word?",
		answer: "Words must be formed by connecting adjacent tiles horizontally or vertically. Valid words are highlighted in green.",
	},
	{
		question: "How do achievements work?",
		answer: "Achievements are earned by reaching score milestones, maintaining play streaks, and discovering special words. View your progress in the Achievements tab.",
	},
	{
		question: "How are points calculated?",
		answer: "Each letter has a point value. Longer words and rare letters earn more points. Your total score is the sum of all valid words created.",
	},
	{
		question: "What are secret achievements?",
		answer: "Secret achievements are hidden challenges that are revealed when you unlock them. Try different word patterns and strategies to discover them!",
	},
	{
		question: "Can I play offline?",
		answer: "Yes! The game works offline. Your progress will sync when you reconnect to the internet.",
	},
	{
