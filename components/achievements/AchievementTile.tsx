		...
		<View style={[styles.badgeContainer, style]}>
			<ThemedView style={[styles.container, { borderColor, backgroundColor }]}>
				<ThemedView style={[styles.contentArea, {backgroundColor}]}>
					<ThemedText variant="strong" style={isWon ? {color: "white"} : {}}>{achievement.name}</ThemedText>
					<ThemedText variant="soft" style={ isWon ? [styles.explainer, {color: "white"}] : styles.explainer}>
