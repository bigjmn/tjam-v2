	...
	(
		...
		const markAsWon = async (
			...
			return new Promise((resolve) => {
				...
				console.log(
					"[NEXTGOALS] Marked as won, playing sound and pulsing",
				);
		...
		return (
			<Animated.View style={[styles.container, blockAnimatedStyle]}>
				...
				{scoring && (
					<Animated.View
						style={[styles.tileWrapper, scoringAnimatedStyle]}
					>
						<AchievementTile
							achievement={scoring}
							isWon={scoringWon}
				...
				{streaking && (
					<Animated.View
						style={[styles.tileWrapper, streakingAnimatedStyle]}
					>
						<AchievementTile
				...
				{novelty && (
					<Animated.View
						style={[styles.tileWrapper, noveltyAnimatedStyle]}
					>
						<AchievementTile
							achievement={novelty}
							isWon={noveltyWon}
