...
const OFFSET = 60;
const icn = <Ionicons name="settings" />
const FloatingActionButton = ({ isExpanded, index, iconName, pressFn }:FloatingActionProps) => {
  ...
  return (
    <AnimatedPressable onPress={pressFn} style={[animatedStyles, styles.shadow, styles.button]}>
...
export default function MenuTest() {
  ...
  const plusIconStyle = useAnimatedStyle(() => {
    ...
    const rotateValue = isExpanded.value ? '90deg' : '0deg';
      ...
      <View style={styles.mainContainer}>
        <View style={styles.buttonContainer}>
          ...
          <FloatingActionButton
            isExpanded={isExpanded}
            index={2}
            iconName={theme === "light" ? "sunny-sharp" : "moon-sharp"}
            pressFn={toggleTheme}
          />
          <FloatingActionButton
            isExpanded={isExpanded}
