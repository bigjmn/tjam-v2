...
export default function OptionSwitches(){
    ...
    return (
        <ThemedView style={styles.container}>
            ...
            <ThemedText style={{marginBottom:5}}>Display Mode</ThemedText>
            <ThemedView style={styles.buttonHolder}>
                <ThemedButton onPress={() => toggleTo("light")} style={{padding:3, width: 100, borderBottomLeftRadius:6, borderTopLeftRadius:6, borderBottomRightRadius:0, borderTopRightRadius:0, backgroundColor: theme === "light" ? "#000" : "#323232"}}>
                    <ThemedText variant='medium' style={{color: "#fff"}}>Light</ThemedText>
                </ThemedButton>
                <ThemedButton onPress={() => toggleTo("dark")} style={{padding:3, width: 100, borderBottomLeftRadius:0, borderTopLeftRadius:0, borderBottomRightRadius:6, borderTopRightRadius:6, backgroundColor: theme === "dark" ? "#000" : "#dfdfdf"}}>
                    <ThemedText variant="medium" style={{color: "#fff"}}>Dark</ThemedText>
                </ThemedButton>
            </ThemedView>
            {theme === "light" && <ThemedText variant="italic">Incorrect.</ThemedText>}
            {theme === "dark" && <ThemedText variant="italic">Correct.</ThemedText>}
            ...
            {!sfxOn && <ThemedText variant="italic">I mean I guess that's fair.</ThemedText>}
            </ThemedView>
            <Spacer height={20} />
