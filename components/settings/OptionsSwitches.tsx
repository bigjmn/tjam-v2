		...
		<ThemedView style={styles.container}>
			...
			<ThemedView style={[styles.optionHolder]}>
				...
				<ThemedView style={styles.buttonHolder}>
					...
					>
						<ThemedText style={{color: theme === "light" ? "white" : colors.text}} variant="medium">Light</ThemedText>
					</ThemedButton>
					<ThemedButton
					...
					>
						<ThemedText style={{color: theme === "dark" ? "white" : colors.text}} variant="medium">Dark</ThemedText>
					</ThemedButton>
				</ThemedView>
				{theme === "light" && (
			...
			<ThemedView style={[styles.optionHolder]}>
				...
				<ThemedView style={styles.buttonHolder}>
					...
					>
						<ThemedText style={{color: sfxOn ? "white" : colors.text}} variant="medium">On</ThemedText>
					</ThemedButton>
					<ThemedButton
					...
					>
						<ThemedText style={{color: sfxOn ? colors.text : "white"}} variant="medium">Off</ThemedText>
					</ThemedButton>
				</ThemedView>
				{sfxOn && (
