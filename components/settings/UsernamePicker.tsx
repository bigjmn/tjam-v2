...
export default function UsernamePicker() {
    ...
    const updateUsername = async (newUsername: string) => {
        ...
        try {
            ...
            await setDoc(
                doc(firestore, "users", user.uid).withConverter(playerStatConverter),
    ...
    const hasChanged = inputValue.trim() !== (playerStats?.username || getDefaultUsername());
        ...
        <ThemedView style={styles.container}>
            ...
            <ThemedView style={styles.inputContainer}>
                ...
                <IconButton
                    ...
                    onPress={hasChanged && !isDisabled ? handleSubmit : handleEdit}
                    disabled={isDisabled}
                    size={20}
            ...
            {/* Success message */}
            {success && (
                <ThemedText variant="soft" style={[styles.message, { color: "#4ade80" }]}>
            ...
            {/* Error message */}
            {error && (
                <ThemedText variant="soft" style={[styles.message, { color: "#ff4444" }]}>
                    {error}
                </ThemedText>
            )}
